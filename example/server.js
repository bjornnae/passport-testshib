"use strict;"
/*
    Example script for the passport-testshib module

    This should be run on a server that will be or
    already has been registered with testshib.org.
*/
...
var testshib = require('passport-testshib');    //testshib Shibboleth auth strategy
...
//create the testshib Shibboleth Strategy and tell Passport to use it
...
app.get(testshib.urls.metadata, testshib.metadataRoute(strategy, samlCert));

//secure all routes following this
//alternatively, you can use ensureAuth as middleware on specific routes
//example:
//  app.get('protected/resource', testshib.ensureAuth(loginUrl), function(req, res) {
//      //route code
//  });
